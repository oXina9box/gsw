...
export async function EntryActions({ secondaryHref = "/login" }: { secondaryHref?: string }) {
  ...
  return <div className="hero-actions">
    <Link className="button button-primary" href={authenticated ? "/app" : "/signup"}>{authenticated ? "Open your Studio" : "Create your Studio"} ↗</Link>
