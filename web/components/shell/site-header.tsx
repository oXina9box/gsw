...
export async function SiteHeader() {
  ...
  return <header className="site-header shell">
    ...
    <nav className="main-nav" id="main-nav" aria-label="Primary navigation">
      ...
      {user ? <><Link href="/app">Dashboard</Link><Link href="/app/builder">Builder</Link><Link href="/app/orchestration">Orchestration</Link><Link href="/app/dna">DNA</Link><Link href="/app/genplay">GenPlay</Link></> : null}
    </nav>
