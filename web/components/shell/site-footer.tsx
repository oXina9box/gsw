...
export async function SiteFooter() {
  ...
  return <footer className="site-footer shell">
    <div className="footer-statement"><span className="footer-mark"><span aria-hidden="true">✦</span> GS/13</span><p>Films for the <span>next signal.</span></p></div>
    <div className="footer-meta">
      ...
      <div><span className="footer-label">Legal & contact</span>{contentApproved ? <><Link href="/terms">Terms</Link><Link href="/privacy">Privacy</Link></> : null}<a href="https://github.com/oXina9box/gem-studio">Source code</a><a href="mailto:hello@gemstudio.app">hello@gemstudio.app</a></div>
    </div>
  </footer>;
}
