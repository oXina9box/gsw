...
const REGISTRY: Readonly<Record<string, Readonly<{ class: string; owner: string; retention: string; export: string; deletion: string; encryption: string; public: boolean; processors: readonly string[] }>>> = Object.freeze({
  ...
  "table:rate_limit_log": { class: "workspace_confidential", owner: "workspace", retention: "90 days", export: "metadata", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:notifications": { class: "workspace_confidential", owner: "workspace", retention: "90 days", export: "metadata", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:channel_staff": { class: "workspace_confidential", owner: "workspace", retention: "account lifetime", export: "workspace export", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:channel_marketing_budgets": { class: "workspace_confidential", owner: "workspace", retention: "account lifetime", export: "workspace export", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:site_content_items": { class: "product_configuration", owner: "platform/operator", retention: "account lifetime", export: "authorized", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:site_content_revisions": { class: "product_configuration", owner: "platform/operator", retention: "account lifetime", export: "authorized", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:site_operator_grants": { class: "security_audit", owner: "platform/operator", retention: "account lifetime", export: "redacted", deletion: "revocation then purge", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:site_operator_audit": { class: "security_audit", owner: "platform/operator", retention: "account lifetime", export: "redacted", deletion: "retention policy", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:site_review_cases": { class: "security_audit", owner: "platform/operator", retention: "account lifetime", export: "redacted", deletion: "retention policy", encryption: "platform", public: false, processors: ["Supabase"] },
  "table:site_review_enforcements": { class: "security_audit", owner: "platform/operator", retention: "account lifetime", export: "redacted", deletion: "retention policy", encryption: "platform", public: false, processors: ["Supabase"] },
  "bucket:site-editorial": { class: "creative_assets", owner: "platform/operator", retention: "account lifetime", export: "authorized", deletion: "purge", encryption: "platform", public: false, processors: ["Supabase Storage"] },
