...
export default async function AssetsPage() {
  ...
  return <section className="product-page shell"><h1>Assets.</h1><p className="lede">Continuity, production contracts, and finished files in one library.</p>{loadError ? <p className="form-error" role="alert">Some asset counts could not load. Refresh to try again.</p> : null}<div className="grid channel-grid">
