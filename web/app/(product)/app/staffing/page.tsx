...
export default async function StaffingPage() {
  ...
  return <section className="product-page shell"><h1>Staffing.</h1><p className="lede">Build internal teams. Review specialist agents available to hire.</p>{loadError ? <p className="form-error" role="alert">Some staffing data could not load. Refresh to try again.</p> : null}<div className="grid channel-grid">
