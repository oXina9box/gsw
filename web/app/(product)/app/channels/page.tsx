...
export default async function ChannelsPage() {
  ...
  return <section className="product-page shell" data-archetype="B1-B"><div className="section-head"><div><h1>Recurring outlets.</h1></div><Link className="button button-primary" href="/app/marketing">Create channel</Link></div>
