...
export default function SocialWorkshopPage() {
  return <article className="marketing-detail" data-archetype="A1">
    ...
    <section className="social-detail-board shell reveal-on-scroll"><div><h2>Cut for the platform. Learn for the next brief.</h2><p>These editorial examples show how native cuts and conversations become creative inputs. Private production signals stay inside the owner’s Studio.</p></div><SignalBoard /></section>
    ...
    <section className="detail-cta shell reveal-on-scroll"><h2>Release planning and manual signals work now.</h2><p>Direct publishing, analytics sync, captions, thumbnails, and social derivatives remain disabled until their adapters are implemented and approved.</p></section>
  </article>;
}
