...
7. Deliver a verdict split into: solid items, blockers needing owner ruling (destructive behavior, legal claims), honesty corrections to annotations, housekeeping (untracked agent harness dirs to gitignore). Do not commit until blockers get explicit rulings when repo law requires ask-first.
