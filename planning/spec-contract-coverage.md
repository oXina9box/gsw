...
No implementation may silently invent behavior where one of these contracts is missing. Record an owner decision or defer the feature to `post-launch.md`.
...
| Deferred work | `post-launch.md` | Scope review; no launch dependency |
